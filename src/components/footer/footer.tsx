            ...
            <WidthContainer>
                <div className="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 items-start justify-center gap-x-20 w-full lg:gap-y-16 md:gap-y-5 gap-y-8 2xl:py-6 xl:py-4 lg:py-4 py-2 2xl:-mt-40">
                    <div className="flex flex-col items-start justify-start 2xl:gap-y-4 xl:gap-y-6 lg:gap-y-2 md:gap-y-1 text-[#8C3239] ">
                        ...
                        <p className="2xl:text-base xl:text-base lg:text-base md:text-xs text-[12px] my-4">
                            Copyright © 2024 N.E.B.S.
                            All Rights Reserved.
                        </p>
                    ...
                    <div className="flex flex-col items-start justify-start md:gap-y-4 gap-y-2">
                        ...
                        <p className="text-[#8C3239] 2xl:text-base xl:text-base lg:text-md md:text-xs text-[12px]">
                            You can subscribe to our newsletter to get updates on new available courses.
                        </p>
                        <Input
                            placeholder="Email"
                            className="border-[1px] 2xl:w-full xl:w-full lg:w-9/12 md:h-8 h-6 border-[#8C3239] placeholder:text-[#8C3239]" />
                        <Button
                            type="submit"
                            className="text-white bg-[#8C3239] lg:h-8 md:h-6 h-6 2xl:text-base xl:text-md lg:text-sm md:text-xs text-[12px] hover:bg-[#8C3239]/80 ">
                            Submit
                        </Button>
                    </div>

                    <div className="hidden xl:flex flex-col items-start justify-start gap-y-4">
                        <p className="text-[#8C3239] font-semibold uppercase 2xl:text-base xl:text-base lg:text-md md:text-sm text-xs">
                            Useful links
                        </p>
